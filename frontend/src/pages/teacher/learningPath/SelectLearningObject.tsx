...
interface SelectLearningObjectProps {
  onSelect: (learningObject: LearningObject) => void; // Callback to pass the selected object
}

const SelectLearningObject: React.FC<SelectLearningObjectProps> = ({
  onSelect,
}) => {
  ...
  const handleSelect = (learningObject: LearningObject) => {
    setSelectedObject(learningObject);
    onSelect(learningObject); // Pass the selected object back
  };
