...
export type FilterOption = {
  name: FilterType | Status | Assignee | Labels | Priority | DueDate | string;
  ...
  [
    {
      ...
      icon: <FilterIcon type={FilterType.LANGUAGE} />,
    },
    {
...
export const filterViewToFilterOptions: Record<FilterType, FilterOption[]> = {
  ...
  [FilterType.LANGUAGE]: [],
  [FilterType.CREATOR]: [], // This will be populated dynamically
};
