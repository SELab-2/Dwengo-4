...
const NavTeacher: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-200 py-2">
      <Container>
        {/* Top row with button-style navigation */}
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <span>Logged in as {firstName || "test"}</span>
            <button className="text-gray-700" aria-label="Notifications">
              <svg
            ...
            <button className="text-gray-700" aria-label="Settings">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
                fill="none"
            ...
            <button className="text-gray-700" aria-label="Logout">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
                fill="none"
