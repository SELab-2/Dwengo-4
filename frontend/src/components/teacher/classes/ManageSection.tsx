...
const ManageSection: React.FC<ManageSectionProps> = ({ classId }) => {
  ...
  return (
    <>
      <div className="container mx-auto p-4">
        <h2 className="text-2xl font-bold mb-4">Beheer Uitnodigingen</h2>
      ...
      <Modal ref={teacherModalRef}>
        <TeacherInvitesModal classId={classId} />
      </Modal>

      {/* Modal wrapper voor de leerling join requests */}
      <Modal ref={studentModalRef}>
        <StudentJoinRequestsModal classId={classId} />
      </Modal>
    </>
  );
};
