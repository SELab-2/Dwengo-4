...
router.post("/:learnPathId/", joinRequestController.createJoinRequest);
router.patch("/:classId/request/:studentId", isTeacher, joinRequestController.updateJoinRequestStatus);
