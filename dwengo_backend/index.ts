...
app.use("/teacher/createdLearningObject", teacherLocalLearningObjectRoutes);
...
app.use("/student/learningObject", learningObjectRoutes);
app.use("/teacher/learningObject", learningObjectRoutes);
