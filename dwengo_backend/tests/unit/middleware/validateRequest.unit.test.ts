...
import { validateRequest, validationErrorMessage } from '../../../middleware/validateRequest'
import { z } from 'zod'
...
describe('validateRequest middleware', () => {
  ...
  it('valideert ook params', () => {
    ...
    } as unknown as  AuthenticatedRequest //lelijk, maar vond er niks beters op
