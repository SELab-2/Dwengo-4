...
describe("invite tests", async (): Promise<void> => {
    ...
    describe("[POST] /teacher/classes/:classId/invites", async (): Promise<void> => {
        ...
        it("should respond with a `400` status code when request body/params are incorrect", async (): Promise<void> => {
            ...
            const { status, body } = await request(app)
                .post(`/teacher/classes/invalided/invites`)
                .set("Authorization", `Bearer ${teacherUser1.token}`)
                .send({
                    otherTeacherId: "sldk",
                });
    ...
    describe("[GET] /teacher/classes/invites", async (): Promise<void> => {
    ...
    describe("[PATCH] /teacher/classes/invites/:inviteId", async (): Promise<void> => {
        let invite: Invite;
        beforeEach(async (): Promise<void> => {
        ...
        it("should respond with a `200` status code and an updated invite when the action is `accept`", async (): Promise<void> => {
            ...
            const classTeacher2: ClassTeacher | null = await prisma.classTeacher.findFirst({
                where: {
    ...
    describe("[DELETE] /teacher/classes/:classId/invites/:inviteId", async (): Promise<void> => {
        let invite: Invite;
        beforeEach(async (): Promise<void> => {
    ...
    describe("[GET] /teacher/classes/:classId/invites", async (): Promise<void> => {
        it("should respond with a `200` status code and a list of invites", async (): Promise<void> => {
