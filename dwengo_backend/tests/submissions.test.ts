...
import {Assignment, LearningPath, Student, Submission, Teacher, User} from '@prisma/client';
import {createAssignment, createSubmission, giveAssignmentToTeam} from './helpers/testDataCreation';
