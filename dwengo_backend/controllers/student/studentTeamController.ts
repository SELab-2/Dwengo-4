 ...
 */
export const getStudentTeams = async (
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Er is iets misgegaan bij het ophalen van de teams." });
  }
};
 ...
 */
export const getTeamByAssignment = async (
  req: AuthenticatedRequest,
  res: Response,
): Promise<void> => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Er is iets misgegaan bij het ophalen van het team." });
  }
};
...
export const getTeamMembers = async (
  ...
  try {
    ...
    console.error(error);
    res.status(500).json({
      error: "Er is iets misgegaan bij het ophalen van de teamleden.",
    });
  }
};
