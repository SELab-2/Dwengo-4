...
export default class StudentService {
    static async findStudentById(userId: number, inclusions: any): Promise<Student> {
    ...
    static async getStudentsByTeamAssignment(assignmentId: number, teamId: number): Promise<Student[]> {
